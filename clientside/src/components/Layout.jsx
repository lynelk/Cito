...
const menuTitles = {
  ...
  'merchant-readiness': { title: 'Merchant lifecycle', subtitle: 'Shared onboarding evidence and readiness blockers; this view does not activate providers.' },
...
const adminRoutes = {
  ...
  'merchant-readiness': '/bo/admin/merchant-readiness',
