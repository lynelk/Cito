...
public class MerchantCommunicationController {
    ...
    public ResponseEntity<?> send(@RequestBody String body, HttpServletRequest request) {
        try {
            ...
            return error(
                    ...
                    "Communication request could not be accepted.");
        }
    }
    ...
    public ResponseEntity<?> bulk(@RequestBody String body, HttpServletRequest request) {
        try {
            ...
            return error(
                    HttpStatus.INTERNAL_SERVER_ERROR,
                    "COMMUNICATION_UNAVAILABLE",
                    "Bulk communication request could not be accepted.");
        }
    }
        ...
        try {
            ...
            return ResponseEntity.ok(
                    communicationService.previewSms(
                            ...
                            truth(input.requireDeliveryReceipts()),
            ...
            return error(
                    HttpStatus.INTERNAL_SERVER_ERROR,
                    "COMMUNICATION_UNAVAILABLE",
                    "Communication preview could not be calculated.");
        }
    }
    ...
    public ResponseEntity<?> status(
        ...
        try {
            ...
            return error(
                    ...
                    "Communication status could not be read.");
        }
    }
    ...
    private Merchant verifiedMerchant(
        ...
        if (blank(merchantNumber))
            throw new IllegalArgumentException("merchantNumber is required.");
    ...
    private void requireSms(String channel) {
        ...
        if (!"SMS".equals(normalized))
            throw new IllegalArgumentException("This endpoint supports SMS.");
    }
